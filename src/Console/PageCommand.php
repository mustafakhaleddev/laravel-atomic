...
class PageCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'atomic:page {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new atomic page';
    ...
    public function handle()
    {
        ...
        (new Filesystem)->copyDirectory(
            __DIR__ . '../../stubs/page-stubs',
            $this->fieldPath()
        );


        // Page.php replacements...
        $this->replace('{{ namespace }}', $this->fieldNamespace(), $this->fieldPath() . '/src/Page.stub');
        $this->replace('{{ class }}', $this->fieldClass(), $this->fieldPath() . '/src/Page.stub');

        (new Filesystem)->move(
            $this->fieldPath() . '/src/Page.stub',
            $this->fieldPath() . '/src/' . $this->fieldClass() . '.php'
        );

        // FieldServiceProvider.php replacements...
        $this->replace('{{ namespace }}', $this->fieldNamespace(), $this->fieldPath() . '/src/PageServiceProvider.stub');
        $this->replace('{{ class }}', $this->fieldClass(), $this->fieldPath() . '/src/PageServiceProvider.stub');

        (new Filesystem)->move(
            $this->fieldPath() . '/src/PageServiceProvider.stub',
            $this->fieldPath() . '/src/PageServiceProvider.php'
        );

        // PageController.php replacements...
        $this->replace('{{ namespace }}', $this->fieldNamespace(), $this->fieldPath() . '/src/Http/Controllers/PageController.stub');

        (new Filesystem)->move(
            $this->fieldPath() . '/src/Http/Controllers/PageController.stub',
            $this->fieldPath() . '/src/Http/Controllers/PageController.php'
        );


        // BaseController.php replacements...
        $this->replace('{{ namespace }}', $this->fieldNamespace(), $this->fieldPath() . '/src/Http/Controllers/BaseController.stub');
        $this->replace('{{ class }}', $this->fieldClass(), $this->fieldPath() . '/src/Http/Controllers/BaseController.stub');

        (new Filesystem)->move(
            $this->fieldPath() . '/src/Http/Controllers/BaseController.stub',
            $this->fieldPath() . '/src/Http/Controllers/BaseController.php'
        );


        // routes.php replacements

        (new Filesystem)->move(
            $this->fieldPath() . '/routes.stub',
            $this->fieldPath() . '/routes.php'
        );
    ...
    {
        return base_path('atomic-components/pages/' . $this->fieldClass());
    }
    ...
    {
        return 'atomic-components/pages/' . $this->fieldClass();
    }
